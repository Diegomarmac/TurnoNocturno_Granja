...
public class ditherERF : ScriptableRendererFeature
{
    class DitherEffectPass : ScriptableRenderPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            {
                Debug.LogError($"Skipping render pass. ditherERF requires an intermediate ColorTexture, we can't use the BackBuffer as a texture input");
                return;
            }
